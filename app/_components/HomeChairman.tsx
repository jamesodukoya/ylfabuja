...
function HomeChairman() {
  return (
    <div className='relative'>
        <div className="chairman bg-cover bg-center bg-fixed xl:px-20 px-5 md:px-10 min-h-[600px] py-20 xl:flex-row flex flex-col items-center">
            <div className='xl:w-1/2 z-20'>
                <h2 className='z-20'>Meet the Chairman</h2>
                <p className='text-3xl pt-8'>Najib A. Waziri</p>
                <p className='small-gold'> Chairman, NBA YLF Abuja</p>
                <div>
                    <a className='button my-10' href='https://www.linkedin.com/in/najib-waziri-3335591ab' target='_blank'>
